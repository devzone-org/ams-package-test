...
class DumpMasterDataPermissions extends Command
{
    ...
    public function handle()
    {
        ...
        Permission::updateOrCreate(['name' => '3.view.admin-expenses'], ['guard_name' => 'web', 'description' => 'View Admin Expenses', 'portal' => 'accounts', 'section' => 'accounts']);
        ...
        Permission::updateOrCreate(['name' => '3.claim.admin-expenses'], ['guard_name' => 'web', 'description' => 'Claim Admin Expenses', 'portal' => 'accounts', 'section' => 'accounts']);
