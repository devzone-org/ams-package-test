                            ...
                            <div class="card-body py-0 pt-2">
                                <div class="row">
                                    <div class="col-xs-6 col-sm-4">
                                        <div class="form-group" id="user-select-group" wire:key="user-select-group">
                                    ...
                                    <div class="col-12 pt-3">
                                        <div class="form-group" id="action-buttons-group" wire:key="action-buttons-group">
        ...
        <div class="mb-4 shadow sm:rounded-md sm:overflow-hidden">
            <div class="bg-white py-6 px-4 space-y-6 sm:p-6">
                <div class="grid grid-cols-6 gap-6">
                    <div class="col-span-6 sm:col-span-2" id="user-select-group" wire:key="user-select-group">
                    ...
                    <div class="col-span-6 sm:col-span-1" id="from-date-group" wire:key="from-date-group">
                        <label for="from_date" class="block text-sm font-medium text-gray-700">From Date</label>
                        <input type="text" wire:model.lazy="from_date" readonly id="from_date" autocomplete="off"
                               class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                    </div>

                    <div class="col-span-6 sm:col-span-1" id="to-date-group" wire:key="to-date-group">
                        <label for="to_date" class="block text-sm font-medium text-gray-700">To Date</label>
                        <input type="text" wire:model.lazy="to_date" readonly id="to_date" autocomplete="off"
                               class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                    </div>
                    <div class="col-span-6 sm:col-span-2" id="action-button-group" wire:key="action-button-group">
