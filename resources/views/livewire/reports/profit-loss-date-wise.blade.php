                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6 col-sm-3 pt-4">
                                            <div class="form-group" id="search-button-group" wire:key="search-button-group">
                                                ...
                                                --}}
                                                @if(!empty($report))
                                                    <a href="{{'date-wise/export'}}?from_date={{date('d M Y', strtotime($from_date))}}&to_date={{date('d M Y', strtotime($to_date))}}&closing_vouchers={{$closing_vouchers}}&selected_user={{$selected_user}}"
                                                       target="_blank"
