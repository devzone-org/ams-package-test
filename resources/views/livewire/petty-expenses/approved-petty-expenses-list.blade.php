            ...
            <div class="row">
                <div class="col">
                    <div class="card card-primary card-outline">
                        <form>
                            <div class="card-header">
                                <h4 class="card-title"><b>Approved Petty Expenses</b></h4>
                            </div>
                            <div class="card-body">
                                <table class="table table-bordered border-0">
                                    ...
                                    <th class="add-services-table text-right text-muted">Approved By</th>
                                    ...
                                    @forelse($petty_expenses_list as $pe)
                                        <tr>
                                            ...
                                            <td>{{ date('d M, Y',strtotime($pe['invoice_date'])) }}</td>
                                            <td>{{ ucwords($pe['vendor_name']) }}
                                                <br>{{ ucwords($pe['vendor_contact_no']) }}</td>
                                            <td>{{ ucwords($pe['account_head']) }}</td>
                                            <td>{{ ucwords($pe['expense_head']) }}</td>
                                            <td>{{ ucfirst($pe['description']) }}</td>
                                            <td>{{ number_format($pe['amount'],2) }}</td>
                                            <td>
