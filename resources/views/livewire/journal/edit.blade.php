                            ...
                            <div class="card-body">
                                ...
                                <div class="card-body table-responsive p-0">
                                    <table class="table table-bordered border-0">
                                        ...
                                        @endforeach
                                        <tr>
                                            <th colspan="3" class="text-right align-middle bg-white">Total</th>
                        ...
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body table-responsive p-0">
                                <table class="table table-bordered border-0">
                                    ...
                                    <th class="text-center add-services-table text-muted" style="width: 25px;">
                        ...
                        @if($customer_account_present)
                            ...
                            @if($invoice_paid == 't')
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <select wire:model="selected_month" multiple
                                            class="mt-1 block w-full bg-white border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                        @foreach($months_array as $k => $ma)
                                            <option value="{{$k}}">{{$ma}}</option>
                                        @endforeach
                                    </select>
                                </div>
{{--                                <div class="col-span-6 sm:col-span-3">--}}
            ...
            <div>
                ...
                <table class="min-w-full table-fixed divide-y divide-gray-200">
                    ...
                    <textarea wire:ignore.self cols="30" rows="1" wire:model.lazy="entries.{{$key}}.description"
                              class="p-0  focus:ring-0 block w-full text-left  text-sm border-0  "></textarea>
                            </td>
                            <td class="px-2    border-r text-sm text-gray-500">
