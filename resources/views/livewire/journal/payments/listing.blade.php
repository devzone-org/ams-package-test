                                ...
                                <div class="row">
                                    <div class="col-xs-6 col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select wire:model="nature" class="form-control">
                                    ...
                                    <div class="col-xs-6 col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" wire:model.lazy="from" id="from"
                            ...
                            <div class="card-body p-0 m-0">
                                ...
                                <div class="table table bordered table-responsive">
                                    <table class="table border-0">
                                        <thead class="">
                                            <th
                                                class="add-services-table text-center pl-3 pr-1 text-muted border-right-0">
                                                #</th>
                                            <th
                                                class="add-services-table text-center text-muted border-left-0 border-right-0">
                                                NATURE
                                            </th>
                                            <th
                                                class="add-services-table text-nowrap text-center text-muted border-left-0 border-right-0">
                                                TRANSACTION DATE
                                            </th>
                                            <th
                                                class="add-services-table text-center text-muted border-left-0 border-right-0">
                                            ...
                                            <th
                                                class="add-services-table text-center text-nowrap text-muted border-left-0 border-right-0">
                                                CREATED BY
                                            </th>
                                            <th
                                                class="add-services-table text-center text-nowrap text-muted border-left-0 border-right-0">
                                        ...
                                        <tbody>
                                            @foreach ($entries as $key => $e)
                                                <tr>
                                                    <td class="align-middle pl-3 pr-1 border-right-0">
                                                        {{ $entries->firstItem() + $key }}</td>
                                                    <td class="align-middle text-center border-right-0 border-left-0">
                                                        ...
                                                        @else
                                                            <span class="badge badge-pill badge-warning">Transfer
                                                                Entry</span>
                                                        @endif
                                                        @if ($e->reversal == 't')
                                                            <br>
                                                    ...
                                                    <td
                                                        class="align-middle text-center text-nowrap border-right-0 border-left-0">
                                                        {{ $e->added_by }} <br>
                ...
                <div class="modal-content">
                    <form wire:submit.prevent="deleteService">
                        ...
                        <div class="modal-footer">
                            <button type="button" wire:click="reverseEntry" class="btn btn-primary">
                            ...
                            <button type="button" wire:loading.attr="disabled" class="btn btn-danger"
                                data-dismiss="modal">
                                Cancel
                            </button>
                        </div>
...
@else
    <div>
                                    ...
                                    <div x-show="open"
                                        ...
                                        <div class="py-1" role="none">
                                            ...
                                            @if (empty($e->approved_at))
                                                ...
                                                @if($e->mode == 'cheque')
                                                    <button type="button" wire:click="showApprovalDateModal('{{ $e->id }}')"
                                                            class="text-gray-700 block w-full text-left px-4 py-2 text-sm hover:bg-gray-100"
                                                            role="menuitem">
                                                        Approve
                                                    </button>
        ...
        <div x-data="{ open: @entangle('approval_date_modal') }" x-show="open" class="fixed z-10 inset-0 overflow-y-auto"
             aria-labelledby="modal-title" x-ref="dialog" aria-modal="true">
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div x-show="open" x-transition:enter="ease-out duration-300"
                    ...
                    @if ($approval_date_modal)
                        ...
                        <div class="sm:flex sm:items-start mt-3" >
                            <div class="w-full">
                                <label for="approval_date" class="block text-sm font-medium text-gray-700">
                                    Approval Date
                                </label>
                                <input
                                        type="date"
                                        ...
                                        id="approval_date"
                                        class="mt-1 block w-full rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm p-2" style="height: 40px;border: 1px solid #ccc;"
                                >
                                @error('approval_date')
                        ...
                        <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                            <button type="button" wire:click="approve({{$approval_id}})"
                                    class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-indigo-600 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:ml-3 sm:w-auto sm:text-sm"
                                    >
                            <span wire:loading.remove wire:target="approveEntry">
                                Approve Entry
                            </span>
                                <span wire:loading wire:target="approveEntry">
                                Please Wait...
                            </span>
                            </button>
                            <button type="button" wire:loading.attr="disabled"
