@php
    if(env('SIDEBAR_NAME') == 'pos'){
        $a_current = "bg-gray-900 text-white rounded";
        $a_default = "text-gray-200 hover:bg-gray-700 hover:text-white rounded ";
    }else{
...
<nav class="flex-1 px-2 mt-5 space-y-1 bg-white"
    ...
    <div @if(Request::segment(2)=='accountant' || Request::segment(2) == 'admin-expenses') x-data="{ isExpanded: true }" @else x-data="{ isExpanded: false }"
         @endif x-cloak
         class="space-y-1">
        <button
            ...
            @if(!env('SIDEBAR_NAME') == 'pos')
                <svg xmlns="http://www.w3.org/2000/svg"
                     class="{{ Request::segment(1)=='accounts' && Request::segment(2) == 'accountant' ? $a_current : '' }} mr-2 h-5 w-5"
        ...
        <div x-show="isExpanded" class="space-y-1">
            ...
            <div class="flex flex-row item-center {{ (Request::segment(3)=='journal' && Request::segment(4)=='add') ? $a_current : $a_default }}">
        ...
        <div x-show="isExpanded" class="space-y-1">
            <div class="flex flex-row item-center {{ (Request::segment(3)=='journal' && empty(Request::segment(4))) ? $a_current : $a_default }}">
        ...
        <div x-show="isExpanded" class="space-y-1">
            ...
            <div class="flex flex-row item-center {{ (Request::segment(3)=='trace-voucher')? $a_current : $a_default }}">
        ...
        <div x-show="isExpanded" class="space-y-1"
        >
            <div class="flex flex-row item-center {{ (Request::segment(3)=='ledger')  ? $a_current : $a_default}}">
        ...
        <div x-show="isExpanded" class="space-y-1"
        >
            <div class="flex flex-row item-center  {{   (Request::segment(3) == 'day-close')  ? $a_current : $a_default}}">
        ...
        <div x-show="isExpanded" class="space-y-1"
        >
            <div class="flex flex-row item-center {{     (Request::segment(3) == 'payments') ? $a_current : $a_default}} ">
        ...
        @can('3.view.admin-expenses')
            <div x-show="isExpanded" class="space-y-1"
            >
                <div class="flex flex-row item-center {{ (Request::segment(2) == 'admin-expenses') ? $a_current : $a_default}}">
                    ...
                    <div wire:click.prevent="selectedFavourite('Admin Expenses','accounts/admin-expenses/list')"
                         class="{{ (Request::segment(2) == 'admin-expenses') ? $a_current : $a_default}} pt-2 rounded-tr-md rounded-br-md cursor-pointer">

                        {{--                            favourite--}}
                        @if(in_array('accounts/admin-expenses/list',$favourite))
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                 class="w-4 h-4 mr-2 text-white">
                                <path fill-rule="evenodd"
                                      d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.007 5.404.433c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.433 2.082-5.006z"
        ...
        <div x-show="isExpanded" class="space-y-1"
        >
            <div class="flex flex-row item-center {{ Request::segment(3)=='chart-of-accounts' && empty(Request::segment(4))  ? $a_current : $a_default}}">
        ...
        <div x-show="isExpanded" class="space-y-1"
        >
            <div class="flex flex-row item-center {{ Request::segment(3)=='chart-of-accounts' && (Request::segment(4) == 'add')  ? $a_current : $a_default}}">
        ...
        <div @if(Request::segment(2)=='reports') x-data="{ isExpanded: true }"
            ...
            <button
                ...
                @if(!env('SIDEBAR_NAME') == 'pos')
                    <svg class="{{ Request::segment(1)=='accounts' && Request::segment(2) == 'reports' ? $a_current : '' }} mr-2 h-5 w-5"
                         fill="none"
            ...
            <div x-show="isExpanded" class="space-y-1"
            >
                <div class="flex flex-row item-center {{ Request::segment(3)=='trial-balance'    ? $a_current : $a_default}}">
            ...
            <div x-show="isExpanded" class="space-y-1">
                <div class="flex flex-row item-center {{ Request::segment(3)=='balance-sheet'  ? $a_current : $a_default}}">
            ...
            <div x-show="isExpanded" class="space-y-1">
                <div class="flex flex-row item-center {{ Request::segment(3)=='profit-and-loss'  ? $a_current : $a_default}}">
            ...
            <div x-show="isExpanded" class="space-y-1">
                ...
                <div class="flex flex-row item-center {{ Request::segment(3)=='day-closing'  ? $a_current : $a_default}}">
    ...
    <div class="space-y-1">
        <h3 class="px-3 mt-4 text-sm font-medium text-gray-500" id="projects-headline">Favourites</h3>
        @foreach($fetch_favourites as $f)
            <div class="space-y-1 flex flex-row {{ Request::is($f['url']) ? $a_current : $a_default }}" role="group"
                 aria-labelledby="projects-headline">
                <a href="/{{$f['url']}}"
                   class=" group w-full flex items-center rounded-md px-3 py-2 text-sm font-medium text-gray-200 hover:text-gray-200">
