...
<div class="relative" x-data="{open:false}">
    ...
    <button type="button" @click="open=true;"
            class="{{ Request::segment(1)=='accounts' && Request::segment(2) == 'accountant' ? $a_current : $a_default }}  flex justify-center px-3 py-2 rounded-md text-sm font-medium"
            aria-expanded="false">
            ...
            <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                ...
                <a href="{{ url('accounts/accountant/ledger') }}"
                   class="-m-3 p-3 flex items-center rounded-lg hover:bg-gray-100 {{ (Request::segment(3)=='ledger' && empty(Request::segment(4)) )  ? 'bg-gray-100' : ''}} ">
                    <svg class="flex-shrink-0 h-6 w-6 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h7"></path></svg>
                    <div class="ml-4">
                        <p class="text-base font-medium text-gray-900">
                            Ledger
                        </p>
...
<div class="relative" x-data="{open:false}">
    ...
    <button type="button" @click="open=true;"
            class="{{ Request::segment(1)=='accounts' && Request::segment(2) == 'reports' ? $a_current : $a_default }}  flex justify-center px-3 py-2 rounded-md text-sm font-medium"
            aria-expanded="false">
        <span>Reports</span>
                ...
                <a href="{{ url('accounts/reports/profit-and-loss') }}"
                   class="-m-3 p-3 flex items-center rounded-lg hover:bg-gray-100 {{ Request::segment(3)=='profit-and-loss'  ? 'bg-gray-100' : ''}} ">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            Financial statement that summarizes the revenues, costs, and expenses incurred during a specified period.
                        </p>
                    </div>
                </a>
