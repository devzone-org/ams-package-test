        ...
        <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
            <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                ...
                <a href="{{ url('accounts/accountant/ledger') }}"
                   class="-m-3 p-3 flex items-center rounded-lg hover:bg-gray-100 {{ (Request::segment(3)=='ledger' && empty(Request::segment(4)) || Request::segment(3)=='journal' && (Request::segment(4) == 'edit'))  ? 'bg-gray-100' : ''}} ">
