        ...
        <div x-show="open" @click.away="open=false"
            ...
            <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                    ...
                    @if(strtolower(env('CLIENT_CODE')) == 'ubh')
                    ...
                    <a href="{{ url('accounts/reports/closing-fiscal-year') }}"
                       class="-m-3 p-3 flex items-center rounded-lg hover:bg-gray-100 {{ Request::segment(3)=='closing-fiscal-year'  ? 'bg-gray-100' : ''}} ">
                    ...
                    @endif
                    @can('4.pnl-template-manager-view')
                        <a href="{{ url('accounts/reports/pnl-template-manager') }}"
                           class="-m-3 p-3 flex items-center rounded-lg hover:bg-gray-100 {{ Request::segment(3)=='pnl-template-manager'  ? 'bg-gray-100' : ''}} ">
                            ...
                            <div class="ml-4">
                                <p class="text-base font-medium text-gray-900">
                                    Pnl Template Manager
                                </p>
                                <p class="mt-1 text-sm text-gray-500">
                                    Create templates for pnl report
                                </p>
                            </div>
                        </a>
                    @endcan
                    @can('4.pnl-template-report')
                        <a href="{{ url('accounts/reports/pnl-template-report') }}"
                           class="-m-3 p-3 flex items-center rounded-lg hover:bg-gray-100 {{ Request::segment(3)=='pnl-template-report'  ? 'bg-gray-100' : ''}} ">
