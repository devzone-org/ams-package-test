                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div class="ml-3 relative" @click.away="dropdown=false;">
                        ...
                        <div x-show="dropdown" x-transition:enter="transition ease-out duration-100"
                            ...
                            <a href="{{ url('logout') }}" @click="dropdown=false"
                               class="block px-4 py-2 text-sm text-gray-700" @mouseenter="activeIndex = 2"
                               @mouseleave="activeIndex = -1" :class="{ 'bg-gray-100': activeIndex === 2 }"
            ...
            <div class="flex items-center px-5">
                <div class="flex-shrink-0">
                    <img class="h-10 w-10 rounded-full"
                         src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixqx=7vUgSUO79Y&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"
                         alt="">
                </div>
                <div class="ml-3">
