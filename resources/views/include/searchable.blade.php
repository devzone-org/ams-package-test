                ...
                <div class="modal-content">
                    <div class="modal-body p-0" id="std_form">
                        <div>
                            ...
                            <div wire:loading.block wire:target="searchable_query" class="px-2 pb-2">
                                <p class="text-muted mb-0">Searching...</p>
                            </div>
                            <div wire:loading.remove wire:target="searchable_query">
    ...
    <div x-cloak x-data="{ open: false }" x-show="open"
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div @click.away="open = false;" x-show="open" x-description="Modal panel, show/hide based on modal state."
                ...
                {{--                Loader--}}
                <div wire:loading wire:target="searchableOpenModal" class="w-full pt-5 pb-5">
                ...
                <div wire:loading.remove wire:target="searchableOpenModal">
                ...
                <div wire:loading.block wire:target="searchable_query">
                    <p class="text-sm opacity-25 pt-0 p-3">Searching...</p>
                </div>
